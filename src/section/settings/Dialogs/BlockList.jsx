...
export default function BlockList({ open, handleClose }) {
    ...
    >
      <div className="md:px-17.5 w-full max-w-142.5 rounded-lg bg-white dark:bg-boxdark md:py-8 px-8 py-12">
        <div className="flex flex-row items-center justify-between mb-6 px-4">
          <span className="font-semibold">Block List ({users.length})</span>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="border border-primary text-primary rounded-md py-2 px-6"
                >
                  Unblock
                </button>
              </div>
